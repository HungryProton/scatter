...
onready var _single_item = $MarginContainer/HBoxContainer/VBoxContainer/SingleItem
...
onready var _rotation = $MarginContainer/HBoxContainer/VBoxContainer2/ApplyRotation
onready var _scale = $MarginContainer/HBoxContainer/VBoxContainer2/ApplyScale
...
func _ready():
	...
	_connect(_single_item, "single_item.gd")
	...
	_connect(_rotation, "apply_rotation.gd")
	_connect(_scale, "apply_scale.gd")
